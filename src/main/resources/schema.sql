...
CREATE TABLE intent_message(intent_message_id INT PRIMARY KEY,message_id INT  NOT NULL,intent_id INT NOT NULL, confidence FLOAT NOT NULL,FOREIGN KEY (intent_id) REFERENCES intent(intent_id),FOREIGN KEY (message_id ) REFERENCES message(message_id) );
